<template>
    <div style="position: relative" v-show="showPanel">
        <div class="verify-bar-area"
            ...
            <div class="verify-control">
                <span class="verify-refresh" style="z-index:10" @click="refresh" v-show="showRefresh">
                    <i class="icon icon-refresh"></i>
                </span>
                <span class="verify-close" style="z-index:10"  v-show="showRefresh" @click="close" >
        ...
        <div class="verify-img-out"
             ...
             :style="mode === 'pop' ?
                                {display: 'none', position: 'absolute', bottom: '12px', height: parseInt(setSize.imgHeight) + vSpace + 'px'} :
...
<script type="text/babel">
    ...
    import {resetSize, _code_color2} from '../utils/util'
    export default {
        name: 'VerifyPoints',
        props: {
            //弹出式pop，固定fixed
        ...
        methods: {
            ...
            drawImg: function (obj, img) {
                ...
                this.text = '请在上图<span style="color:skyblue">依次</span>点击【' + msgStr.substring(0, msgStr.length - 1) + '】'
                this.showImage = true;
                return this.fontPos;
            },
            //获取坐标
            ...
            refresh: function () {
                ...
                var canvas = this.$refs.canvas;
                canvas.setAttribute('height', this.setSize.imgHeight)
