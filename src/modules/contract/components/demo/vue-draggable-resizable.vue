...
<template>
  <div class="drag-test">
    ...
    <div class="drag-wrap">
      <vue-draggable-resizable v-for="(item, index) in controlsArr"
                               :key="item.customId"
                               :ref="item.customId"
        ...
        <i class="close el-icon-circle-close"
           @click="removeControl(item.customId)"></i>
        <div class="seal-inner"
             :class="commonClassName">
          <div class="seal"
               :class="commonClassName"></div>
        </div>
    ...
    <div class="set-wrap">
      ...
      <div class="control-set-item"
        ...
        <el-select size="mini"
                   ...
                   placeholder="请选择">
          <el-option v-for="item in fontSizeOptions"
                     :key="item.value"
                     :label="item.label"
                     :value="item.value">
          </el-option>
      ...
      <div class="control-set-item">
        ...
        <el-select size="mini"
                   ...
                   placeholder="请选择">
          <el-option v-for="item in signatoryOptions"
                     :key="item.value"
                     :label="item.label"
                     :value="item.value">
          </el-option>
